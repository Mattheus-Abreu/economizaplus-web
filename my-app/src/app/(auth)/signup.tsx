...
function signup() {
  ...
  async function handleSignup() {
    ...
    try {
      ...
      await AsyncStorage.removeItem("@myapp:onboarding-done");
          ...
          <View>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.field}>
                ...
                <View style={[styles.fieldInput, email.length > 0 && styles.fieldInputActive]}>
                  <FontAwesome
                    name="envelope-o"
                    size={18}
              ...
              <View style={styles.field}>
                ...
                <View style={[styles.fieldInput, password.length > 0 && styles.fieldInputActive]}>
                  <Ionicons
              ...
              <View style={styles.field}>
                ...
                <View style={[styles.fieldInput, confirmPassword.length > 0 && styles.fieldInputActive]}>
                  <Ionicons
                    name="lock-closed-outline"
                    size={20}
